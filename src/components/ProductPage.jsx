...
function ProductPage(props) {
  ...
  const handleAddToCart = (product) => {
    ...
    if (
      ...
      setButtonCount((prevState) => ({
        ...prevState,
        [product.id]: (prevState[product.id] || 0) + 1,
      }));
      // // Store the updated buttonCount in local storage
      // localStorage.setItem("buttonCount", JSON.stringify(buttonCount));
    }
  };
            ...
            {product.inventory > 0 ? (
              <React.Fragment>
                ...
                <button
                  ...
                  disabled={
                    buttonCount[product.id] >= product.inventory ||
                    product.inventory === 0
                  }
                >
